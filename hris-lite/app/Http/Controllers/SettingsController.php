...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, SettingsManager $settings): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'attendance.shift_start' => ['required', 'date_format:H:i'],
            'attendance.shift_end' => ['required', 'date_format:H:i'],
            'attendance.break_minutes' => ['required', 'integer', 'min:0'],
            'attendance.night_diff_start' => ['required', 'date_format:H:i'],
            'attendance.night_diff_end' => ['required', 'date_format:H:i'],
